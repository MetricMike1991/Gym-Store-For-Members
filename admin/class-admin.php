...
class GSFM_Admin {
	...
	public function handle_posts() {
		...
		if ( isset( $_POST['gsfm_save_product'] ) ) {
			...
			$mode       = ( isset( $_POST['request_mode'] ) && 'vending' === $_POST['request_mode'] ) ? 'vending' : 'order';
			GSFM_Products::set_prices( $id, $rrp, $sale_price, $vat_rate );
			GSFM_Products::set_visible( $id, $visible );
			GSFM_Products::set_display_options( $id, $hide_price, $button, $mode );
	...
	private function save_settings() {
		...
		$fields = array( 'product_link_pattern', 'openai_model', 'login_url', 'listing_url', 'page_param', 'username_field', 'password_field', 'username', 'xpath_item', 'xpath_title', 'xpath_image', 'xpath_price', 'xpath_stock', 'xpath_ref', 'in_stock_text', 'access_page_url', 'shop_page_url' );
